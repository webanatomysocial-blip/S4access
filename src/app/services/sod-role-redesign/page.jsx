                    ...
                    <div className="journey-card">
                        <div className="card-header left-right-container-inner-service">
                            ...
                            <div className="card-sub-content card-sub-content-only-some">
                                ...
                                <p className="text-white">
                                    Many organizations using SAP eventually face a familiar challenge: access and role structures become difficult to manage, leading to rising <Link href="/blogs/sap-access-governance-sod-risk">Segregation of Duties (SoD) risks</Link>, audit findings, and security concerns.
                                </p>
                                <p className="text-white">
