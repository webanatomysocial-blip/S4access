 ...
 const faqs = [
  {
    ...
    answer: <>No, you don’t. If you already have <Link href="/blogs/sap-access-management-consultant-guide">SAP GRC</Link>, we can deliver the service using your existing setup. If not, we offer a fully functional alternative that does not require SAP GRC installation, making it easier and faster to get started.</>
  },
  {
            ...
            <div className="card-header">
              ...
              <div className="card-sub-content">
                <p className="text-white">
                  ...
                  emergency users, or <Link href="/blogs/when-access-becomes-a-risk-how-firefighter-ids-help-you-stay-compliant">firefighters</Link>{" "}
          ...
          <div className="solution-grid sod-solution-grid">
            ...
            <div className="solution-cards sod-deliverables-cards">
              <div className="solution-card">
                ...
                <p className="small-text-white">Compatible with <Link href="/blogs/sap-access-management-consultant-guide">SAP GRC</Link> and non-GRC environments</p>
              </div>
