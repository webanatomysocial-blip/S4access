                ...
                <div className="service-solution-content ">
                    <div className="solution-grid sod-solution-grid">
                        <div className="solution-intro-card only-windows">
                            ...
                            <div className="card-sub-content">
                                <p className="text-white">
                                    We provide continuous support to help organizations build and maintain a strong SAP security architecture that evolves with their business and IT landscape. Our ongoing consulting service ensures your <Link href="/services/sap-access-management-automation">SAP access management</Link> remains aligned with compliance requirements, operational needs, and enterprise architecture.
                                </p>
                        ...
                        <div className="solution-cards sod-deliverables-cards">
                            ...
                            <div className="solution-card">
                                ...
                                <p className="small-text-white">Ongoing role and <Link href="/services/authorisation-concept-owner">authorization concept optimization</Link></p>
                            </div>
