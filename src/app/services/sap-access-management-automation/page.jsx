                ...
                <div className="service-solution-content ">
                    <div className="solution-grid sod-solution-grid">
                        <div className="solution-intro-card only-windows">
                            ...
                            <div className="card-sub-content">
                                <p className="text-white">
                                    This service helps organizations design a technology strategy that supports effective SAP Access Management and <Link href="/services/sod-strategy-approach">Segregation of Duties (SoD)</Link>. We guide you in aligning tool selection with your overall access management approach—ensuring that technology investments deliver real value in compliance, security, and efficiency.
                                </p>
                        ...
                        <div className="solution-cards sod-deliverables-cards">
                            <div className="solution-card">
                                ...
                                <p className="small-text-white">Assessment of current tools and <Link href="/blogs/sap-access-management-ciso-2026">access management practices</Link>
                                </p>
                            </div>
