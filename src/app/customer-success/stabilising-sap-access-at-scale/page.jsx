    ...
    <div>
      ...
      >
        <div className="Coustomer-success-page-hero-container-left">
          <h1 className="big-heading-text-white">
            Stabilising SAP Access at Scale During an S/4HANA Transformation
          </h1>
          <p className="text-white">
            A global health and hygiene products manufacturer was in the middle
            of an SAP S/4HANA pilot when significant issues emerged around user
            authorizations. The existing authorization concept was not scalable,
            leading to widespread segregation of duties (SoD) conflicts and
            difficult role maintenance.
          </p>
        </div>
        <div className="Coustomer-success-page-hero-container-right">
          <Image
            src={img1}
            alt="S/4HANA Transformation"
            style={{ width: "540px" }}
          />
        </div>
      </section>
      ...
      <div className="card-con-heading">
        <div className="solution-intro-card-2">
          ...
          <p className="text-white">
            The internal maintenance team struggled to keep up with frequent
            changes and user assignments, and the pilot environment no longer
            met compliance requirements. Without intervention, the authorization
            model would have become a major risk as the{" "}
            <Link
              href="/blogs/building-display-roles-the-smart-way-in-sap-s4hana"
      ...
      <section className="Coustomer-success-page-scope-of-service-section">
        <div className="Coustomer-success-page-card">
          ...
          <p className="text-black">
            s4access was engaged to redesign the{" "}
            <Link
              href="/services/authorisation-concept-owner"
              style={{ color: "inherit", textDecoration: "underline" }}
            >
              SAP authorization concept
            </Link>{" "}
            to better support both compliance and operational needs. We designed
            a customer-specific S/4 authorization and SoD concept, built around
            simplified and clearly structured SoD roles.
          </p>
          <p className="text-black">
            Rather than replacing everything at once, the new model was
            introduced in a phased manner. Existing pilot users were retrofitted
            step by step, allowing business operations to continue without
            disruption. Once validated, the new{" "}
            <Link
              href="/services/authorisation-concept-owner"
              style={{ color: "inherit", textDecoration: "underline" }}
            >
            ...
            was rolled out in multiple deployment waves across six European
            countries.
            <br />
            <br />
            The engagement started in 2024 and continues today, with a dedicated
            team of approximately 14 specialists supporting the customer.
          </p>
        </div>
      ...
      <section className="Coustomer-success-page-Achievements-section">
        ...
        <div className="Coustomer-success-page-achievements-grid">
          <div className="Coustomer-success-page-achievement-card">
            ...
            <h3 className="sub-big-heading-text-black">
              Stable and scalable model
            </h3>
            <p className="small-text-black">
              A robust authorization model now supports the customer’s complex
              S/4 landscape.
            </p>
          </div>
          <div className="Coustomer-success-page-achievement-card">
            ...
            <p className="small-text-black">
              Over 4,000 users are already successfully operating under the new
              concept.
            </p>
          </div>
          <div className="Coustomer-success-page-achievement-card">
            ...
            <p className="small-text-black">
              In the most recent go-live, less than 5% of defects were related
        ...
        <div className="Coustomer-success-page-achievements-grid">
          <div className="Coustomer-success-page-achievement-card">
            ...
            <p className="small-text-black">
              More controlled change process for role maintenance and quicker
              support.
            </p>
          </div>
          <div className="Coustomer-success-page-achievement-card">
            ...
            <p className="small-text-black">
              Solutions tailored specifically to the customer's unique
          ...
          <div className="Coustomer-success-page-achievement-card">
            ...
            <p className="small-text-black">
              Continued support as a trusted advisor shaping long-term SAP
      ...
      <section className="CustomerSuccess-service-cta">
        <div className="CustomerSuccess-cta-content">
          ...
          <p className="text-white">
            The customer has appreciated the structured approach to streamlining
            their authorization concept, as well as the quality and speed of
            delivery. s4access continues to support the customer not only
            operationally, but also as a trusted advisor.
          </p>
        </div>
