...
const services = [
  {
    ...
    items: [
      ...
      { 
        ...
        link: '/services/sod-strategy-approach' 
      },
      { 
        ...
        link: '/services/sap-access-management-automation' 
      }
    ]
  },
  {
    ...
    items: [
      ...
      { 
        ...
        link: '/services/sod-role-redesign'
      },
      { 
        ...
        link: '/services/reorganisation-ma-projects'
      }
    ]
  },
  {
    ...
    items: [
      { 
        ...
        link: '/services/outsourced-access-management'
      },
      { 
        ...
        link: '/services/authorisation-concept-owner'
      },
      { 
        ...
        link: '/services/security-architect'
      }
    ]
  },
  {
    ...
    items: [
      { 
        ...
        link: '/services/access-risk-sod-management'
      },
      { 
        ...
        link: '/services/ff-log-review-automation'
      },
      { 
        ...
        link: '/services/sap-license-optimisation'
      }
    ]
  }
];
          ...
          category.items.map((service, itemIdx) => (
            ...
            >
              <div className='scrolling-link-our-services-container'>
                ...
                <a href={service.link} className='main-button-blue'>
