                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "mainEntity": [
                            {
                                "@type": "Question",
                                "name": "How do reorganisations impact SAP Access Management?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Reorganisations can significantly impact SAP Access Management by changing reporting lines, job roles, and responsibilities. This often leads to outdated or misaligned access rights, increased SoD risks, and the need for role redesign."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "Do reorganizations require a full role redesign in SAP?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Not often. Reorganizations don’t always require a full role redesign, but they do demand careful analysis. The key is to identify the impact early and choose the best way to adapt roles without compromising the existing SAP authorization concept."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "Do you leverage technology or accelerators to improve efficiency in your work?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Yes, we use technology and accelerators during both planning and implementation phases whenever feasible. These tools help streamline the process, improve accuracy, and make the work more efficient—without compromising quality or compliance."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "Why are Mergers and Acquisitions challenging for SAP Access Management?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "M&A often require rapid changes, and these actions are rarely designed with SAP security in mind, leading to difficult situations such as access risks, compliance gaps, and operational disruptions."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "How do you approach these challenging situations?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "We leverage deep expertise to quickly assess the situation and deploy a specialized team on short notice to ensure secure and compliant SAP access management."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "How can organizations running SAP effectively prepare for M&A scenarios from an access management perspective?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Thanks to our experience across various M&A scenarios, we can advise internal teams early—helping them prepare proactively and avoid surprises in SAP access management."
                                }
                            }
                        ]
                    })}
