    ...
    return (
        <div className="linktree-container">
            <Helmet>
                ...
                <meta name="description" content="All your s4access links in one place." />
            </Helmet>

            <header className="linktree-header">
                <img src={logo} alt="s4access Logo" className="linktree-logo" />
            ...
            <footer className="linktree-footer">
                <p>
                   Go to Home Page<a href="https://s4access.com" target="_blank" rel="noopener noreferrer"> s4access</a>
                </p>
            </footer>
        </div>
    );
